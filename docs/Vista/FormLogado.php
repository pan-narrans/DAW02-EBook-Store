  ...
  <article class="col-md-6 col-sm-12">
    ...
    <form action="" id="landingForm" aria-label="Formulario para darse de alta en la tienda.">
      ...
      <fieldset>
        ...
        <div id="password_alerts">
          <p id="password_alert_match" class="text-danger">
          <p id="password_alert_length" class="text-danger">
          <p id="password_alert_uppercase" class="text-danger">
          <p id="password_alert_lowercase" class="text-danger">
          <p id="password_alert_number" class="text-danger">
          <p id="password_alert_symbol" class="text-danger">
        </div>
      </fieldset>
